...
O Blume escreve um `sitemap.xml` com todas as páginas indexáveis no momento do build. Ele precisa de um [`deployment.site`](/docs/deployment) absoluto e lista todas as páginas, exceto rascunhos, ocultas e páginas com `noindex`. Ativado por padrão:
