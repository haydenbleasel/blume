...
:::warning
Scalars AsyncAPI-Unterstützung befindet sich noch in Arbeit – sie rendert Channels, Operationen, Messages und einen Models-Abschnitt, aber es gibt noch **keinen interaktiven Playground** für Events. Sie wird im Upstream nach und nach verbessert.
:::
