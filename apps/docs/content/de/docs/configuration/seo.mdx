...
Blume schreibt zur Build-Zeit eine `sitemap.xml` mit jeder indexierbaren Seite. Sie benötigt ein absolutes [`deployment.site`](/docs/deployment) und listet jede Seite auf, außer Entwürfen, versteckten und `noindex`-Seiten. Standardmäßig aktiviert:
