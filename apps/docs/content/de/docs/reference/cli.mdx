...
- **Ankerlinks** (`#section`, `/guides/intro#setup`) müssen einem Anker auf der Zielseite entsprechen — der id einer Überschrift (generiert oder [festgelegt](/docs/content/syntax#custom-anchors)) oder dem `id`-Attribut eines reinen HTML-Elements —, wobei Fehlschläge als Warnungen gemeldet werden. Ids in Codeblöcken, Inline-Code, HTML-Kommentaren und `<Prompt>`-Blöcken zählen nicht.
