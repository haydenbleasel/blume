...
| `reference` | API references: `openapi()`, `asyncapi()`, and `graphql()` adapters from `blume/reference` | [OpenAPI / AsyncAPI](/docs/advanced/api-reference), [GraphQL](/docs/advanced/graphql) |
