...
- **Asset links** are checked where the file lives: an absolute path (`/logo.png`) against the `public/` directory, a relative image (`./diagram.png`) against the page's own folder.
