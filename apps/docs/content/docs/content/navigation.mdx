...
Enabled OpenAPI and AsyncAPI references are added as header tabs automatically. Set `generatedTabs: false` to render only your explicit tabs while keeping generated destinations available at their routes:
