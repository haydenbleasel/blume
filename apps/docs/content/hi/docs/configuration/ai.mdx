...
एजेंट्स को `.md` परंपरा जानने की ज़रूरत नहीं है: किसी पेज के अपने URL को [`Accept: text/markdown`](https://acceptmarkdown.com) हेडर के साथ अनुरोध करने पर उसी पते पर Markdown वैरिएंट सर्व होता है, `Vary: Accept` के साथ ताकि कैश दोनों को अलग रखें। dev सर्वर हेडर को बिना किसी सेटअप के सम्मानित करता है, और एक [Vercel सर्वर बिल्ड](/docs/deployment#server-rendering) उसी नेगोशिएशन को डिप्लॉय के रूटिंग नियमों में स्वचालित रूप से जोड़ देता है — किसी कॉन्फ़िगरेशन की आवश्यकता नहीं। होमपेज हमेशा नेगोशिएट करता है, तब भी जब वह किसी कंटेंट पेज के बजाय एक कस्टम लैंडिंग पेज हो: उसका Markdown प्रतिबिंब [`llms.txt`](#llmstxt) इंडेक्स पर वापस गिरता है, इसलिए साइट रूट से Markdown माँगने वाले एजेंट को साइट का मशीन-पठनीय नक्शा मिलता है। Markdown प्रतिक्रियाएँ एक `x-markdown-tokens` हेडर भी ले जाती हैं — एक अनुमानित टोकन गणना (~4 अक्षर प्रति टोकन), [Cloudflare के Markdown for Agents](https://developers.cloudflare.com/fundamentals/reference/markdown-for-agents/) की परंपरा का अनुसरण करते हुए — हर उस सतह पर जहाँ Blume प्रतिक्रिया हेडर नियंत्रित करता है: dev सर्वर, सर्वर-रेंडर की गई प्रतिक्रियाएँ, और Vercel पर नेगोशिएट किया गया होमपेज। अन्य डिप्लॉय लक्ष्य पूर्व-रेंडर किए गए पेजों को एक स्टैटिक परत से सर्व करते हैं जिसमें अनुरोध-समय का कोई हुक नहीं होता, इसलिए वहाँ एजेंट सीधे `.md` URL लाते हैं; [एजेंट रीडेबिलिटी मैनिफ़ेस्ट](#agent-readability) केवल उन डिप्लॉयमेंट्स पर `contentNegotiation` का विज्ञापन करता है जो हेडर को सम्मानित करते हैं।
