...
HTML. The folder name is configurable with [`content.pages`](/configuration#content)
(default `"pages"`).
...
[generated changelog timeline](/advanced/changelog) with your own.
...
[`blume eject`](/configuration/customization#eject) turns `.blume/` into a
...
[islands](/configuration/customization#react-islands) with a hydration directive.
React switches on automatically the moment your project contains a `.tsx` or
`.jsx` file.

<CardGroup cols={2}>
  <Card title="Customization" href="/configuration/customization" icon="file">
    Component overrides, React islands, the registry, and eject.
  </Card>
  <Card title="Blog" href="/advanced/blog" icon="book-open">
