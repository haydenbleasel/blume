...
:::note
The reference is a **self-contained embed** with its own sidebar, search, and
theme. By design it doesn't weave into Blume's content sidebar, site search, or
`llms.txt` — it's a bolt-on route, not part of the docs shell.
:::
...
By default Blume layers your [accent and radius](/configuration/theming) onto
