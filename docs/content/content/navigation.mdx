...
- a page's label is its frontmatter `title`; a group's label is the humanized
  folder name
- items sort by [numeric prefix](/content), then alphabetically, and a folder's
...
See [Frontmatter](/reference/frontmatter) for the full page schema.
...
see [Pages](/content#group-folders).
...
- **Edit this page on GitHub** — links straight to the source file. Appears once
  you set [`github`](/configuration) in your config.
...
**Ask AI about this page** — covered in [AI](/configuration/ai#copy-as-markdown).
