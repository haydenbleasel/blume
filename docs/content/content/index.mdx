...
[`/changelog` timeline](/advanced/changelog). See [Blog](/advanced/blog) and
[Changelog](/advanced/changelog) for authoring each.
...
discover them automatically. See [Blog](/advanced/blog) and
[Changelog](/advanced/changelog) for authoring each content type.
