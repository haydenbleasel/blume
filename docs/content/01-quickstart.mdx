...
**Node.js 20 or newer** and a `docs/` folder with at least one `.md` or `.mdx`
...
Every page is Markdown or MDX with a little frontmatter. Drop this into
`docs/index.mdx`:
...
<CardGroup cols={2}>
  ...
  <Card title="Deployment" href="/deployment" icon="rocket">
