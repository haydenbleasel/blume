...
:::tip Ready to make this your own? Start by editing this page. Update your `docs.json` file to customize your site. Then fill out the [Quickstart](/quickstart) page. :::
...
<Card
  title="Components"
  icon="puzzle-piece"
  href="https://useblume.dev/docs/components"
>
...
<Card
  title="Settings"
  icon="gear"
  href="https://useblume.dev/docs/organize/settings"
>
