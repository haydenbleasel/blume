...
<Note title="Note">Supplemental information.</Note>

<Info title="Info">Helpful context.</Info>

<Tip title="Tip">Recommended path.</Tip>

<Warning title="Warning">Potentially risky action.</Warning>

<Check title="Check">Successful outcome.</Check>

<Danger title="Danger">Destructive action.</Danger>
...
<Banner title="Banner" type="warning">
  Banner component usage inside MDX.
</Banner>
...
>
  This banner uses custom colors and can be dismissed.
</Banner>
...
<AccordionGroup>
  ...
  <Accordion title="Second accordion">More accordion content.</Accordion>
</AccordionGroup>
...
<Update
  ...
  tags={["Blume", "Docs"]}
  rss={{
    title: "June 2026 - Blume docs compatibility",
    description: "Mintlify-style update metadata renders in Blume."
  }}
>
...
<ResponseField name="user.id" type="string" required pre={["uuid"]}>
  Unique user identifier.
</ResponseField>

<RequestExample dropdown title="Create user">
...
<ResponseExample dropdown title="200 OK">
